> Implements approved behavior slices with TDD and stands up the acceptance pipeline. Present in every pack.
...
- Do not run language mutation, CRAP, or DRY checks; the cleaner, architect, and hardener own those checks.
- Do not run Gherkin acceptance mutation.

## Handoff

- Hand off only when all acceptance and unit tests pass.
- Next role: **cleaner**.
